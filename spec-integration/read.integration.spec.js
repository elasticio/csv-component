...
describe('CSV Read component integration tests', function readCsvIntegrationTests() {
    let csv = require('../lib/read.js');
    let runTest = require('../spec/testrunner.js').runTest;
    ...
    it('winter12.csv', function winter12Test(done) {
        let msg = {};
        ...
        runTest(csv.process, msg, cfg, function winter12TestAssertions(runner) {
